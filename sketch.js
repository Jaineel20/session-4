...
let maze = []
var scorllimg
var goldimg, playerimg, tileimg, refreshbutton
...
function setup() {
    ...
    refreshbutton = createImg("restart.png")
    refreshbutton.position(width / 2 - 20, height - 150)
    refreshbutton.size(250, 200)
    refreshbutton.hide()
